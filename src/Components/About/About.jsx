  ...
  return (
    <div className='about'>
        ...
        <div className="about-right">
            ...
            <p>With a focus on innovation, hands-on learning and personalized mentorship, our progress prepare aspiring educators to make a meaningful impact in classrooms, schools,and communities.</p>
